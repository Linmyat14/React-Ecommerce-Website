    ...
    <div className="container released-container text-center">
        ...
        <div className="row">
            <div className="col-6 col-md-4 col-lg-3 mt-lg-0 mt-2">
                <img className="w-100 rounded-4" src="../../public/images/new-released-1.jpg" alt="" />
            </div>
            <div className="col-6 col-md-4 col-lg-3 mt-lg-0 mt-2">
                <img className="w-100 rounded-4" src="../../public/images/new-released-2.jpg" alt="" />
            </div>
            <div className="col-6 col-md-4 col-lg-3 mt-lg-0 mt-2">
                <img className="w-100 rounded-4" src="../../public/images/new-released-3.jpg" alt="" />
            </div>
            <div className="col-6 col-md-4 col-lg-3 mt-lg-0 mt-2">
                <img className="w-100 rounded-4" src="../../public/images/new-released-4.jpg" alt="" />
            </div>
        </div>
